...
const page = () => {
  return (
    <Container className="relative overflow-hidden">
      <div className="bg-primary/15 dark:bg-primary/10 absolute top-0 right-1/16 bottom-60 h-60 w-[150px] -translate-x-1/2 -translate-y-1/2 rounded-full blur-[100px]"></div>
