...
export function FeaturesSection() {
  ...
  return (
    <>
      <SectionHeading
        title="Features"
        description="Everything you need to build a modern From image editing to text generation, we've got you covered."
      />
      <div
        id="features"
        className="relative z-10 mx-auto grid max-w-7xl grid-cols-1 pb-10 md:grid-cols-2 lg:grid-cols-4"
      >
